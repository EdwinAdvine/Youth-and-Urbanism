  ...
  if (variant === 'grid') {
    return (
      <motion.div
        ...
        onClick={handleClick}
        className="group cursor-pointer bg-[#181C1F] border border-[#22272B] rounded-xl overflow-hidden
      ...
      >
          ...
          <span
            className={`absolute top-3 right-3 px-2.5 py-1 text-xs font-bold rounded-md backdrop-blur-sm ${
              isFree
                ...
                : 'bg-[#181C1F]/80 text-white border border-[#22272B]'
            }`}
          >
            {priceText}
          </span>
        ...
        <div className="p-4 flex flex-col gap-3">
          {/* Learning area tag */}
          <span className="self-start text-[11px] font-medium uppercase tracking-wider text-gray-500 bg-[#22272B] px-2 py-0.5 rounded">
  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex flex-col justify-between flex-1 min-w-0">
        <div>
          {/* Learning area tag */}
          <span className="inline-block text-[11px] font-medium uppercase tracking-wider text-gray-500 bg-[#22272B] px-2 py-0.5 rounded mb-2">
            {course.learning_area}
          </span>

          {/* Title */}
          <h3 className="text-base font-semibold text-white leading-snug line-clamp-2 group-hover:text-red-400 transition-colors mb-1">
            {course.title}
          </h3>
