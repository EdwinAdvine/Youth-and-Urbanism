    ...
    <div className="bg-[#181C1F] border border-[#22272B] rounded-xl overflow-hidden">
      ...
      <div className="p-4 space-y-4">
        ...
        <div>
          ...
          {currentStaff ? (
            <div className="flex items-center gap-3 p-3 rounded-lg bg-[#22272B]/50 border border-[#22272B]">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-sm font-medium text-white truncate">{currentStaff.name}</p>
                <p className="text-xs text-white/40">{currentStaff.role}</p>
              </div>
            ...
            <div className="flex items-center gap-2 p-3 rounded-lg bg-[#22272B]/30 border border-dashed border-[#22272B]">
        ...
        <div className="relative">
          <button
            ...
            className="w-full flex items-center justify-between px-3 py-2.5 bg-[#22272B]/50 border border-[#22272B] rounded-lg text-sm text-white/60 hover:text-white hover:border-[#333] transition-colors"
          >
          ...
          {showDropdown && (
            <div className="absolute z-10 w-full mt-1 bg-[#1a1f23] border border-[#22272B] rounded-lg shadow-xl overflow-hidden">
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-3 py-2.5 text-left transition-colors ${
                    staff.id === currentAssignee
                      ? 'opacity-40 cursor-not-allowed bg-[#22272B]/30'
                      : 'hover:bg-[#22272B]/50'
                  }`}
                >
                  <div className="w-7 h-7 rounded-full bg-[#22272B] flex items-center justify-center flex-shrink-0">
      ...
      {showEscalateModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
          <div className="bg-[#181C1F] border border-[#22272B] rounded-xl w-full max-w-md overflow-hidden">
            <div className="flex items-center justify-between px-5 py-3.5 border-b border-[#22272B]">
              <div className="flex items-center gap-2">
                <AlertOctagon className="w-4 h-4 text-orange-400" />
                <h3 className="text-sm font-semibold text-white">Escalate Ticket</h3>
              </div>
              <button
                onClick={() => {
                  setShowEscalateModal(false);
            ...
            <div className="p-5">
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-3 py-2.5 bg-[#22272B]/50 border border-[#22272B] rounded-lg text-sm text-white placeholder:text-white/30 outline-none focus:border-orange-500/50 resize-none transition-colors"
                autoFocus
              />
            </div>
            <div className="flex items-center justify-end gap-2 px-5 py-3.5 border-t border-[#22272B]">
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-white bg-orange-600 rounded-lg hover:bg-orange-600/90 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
              >
                Escalate
              </button>
            </div>
