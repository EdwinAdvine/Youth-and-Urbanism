...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      { label: 'Student Guide', path: '/docs/student-guide' },
      { label: 'Parent Guide', path: '/docs/parent-guide' },
      { label: 'Instructor Guide', path: '/docs/instructor-guide' },
      { label: 'Partner Guide', path: '/docs/partner-guide' },
      { label: 'Courses', path: '/docs/courses' },
      { label: 'Assessments', path: '/docs/assessments' },
      { label: 'Payments', path: '/docs/payments' },
      { label: 'Forum', path: '/docs/forum' },
      { label: 'Store', path: '/docs/store' },
      { label: 'Certificates', path: '/docs/certificates' },
    ],
  },
  {
    title: 'Urban Bird v1',
    items: [
      { label: 'AI Tutor', path: '/docs/ai-tutor' },
      { label: 'CoPilot', path: '/docs/copilot' },
      { label: 'Voice Mode', path: '/docs/voice-mode' },
      { label: 'Learning Paths', path: '/docs/learning-paths' },
    ],
  },
  {
    title: 'API Reference',
