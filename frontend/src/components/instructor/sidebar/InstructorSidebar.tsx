    ...
    // 3. STUDENTS & ENGAGEMENT
    {
      ...
      children: [
        ...
        },
        {
          ...
          path: '/dashboard/instructor/progress',
        },
        {
          id: 'interventions',
    ...
    // 4. IMPACT & RECOGNITION
    {
      ...
      children: [
        ...
        },
        {
          ...
          path: '/dashboard/instructor/sentiment',
          isNew: true,
        },
        {
          id: 'performance',
    ...
    // 5. EARNINGS & FINANCES
    {
      ...
      children: [
        ...
        },
        {
          ...
          path: '/dashboard/instructor/payouts',
        ...
        },
        {
          ...
          path: '/dashboard/instructor/rates',
        },
        {
          id: 'documents',
          title: 'Tax & Invoices',
          icon: <FileText className="w-4 h-4" />,
          path: '/dashboard/instructor/documents',
        },
      ],
    },
    // 6. INSTRUCTOR HUB
      ...
      children: [
        {
          ...
          icon: <BookMarked className="w-4 h-4" />,
          path: '/dashboard/instructor/hub/cbc',
        },
        {
          id: 'ai-prompts',
          title: 'AI Prompts & Templates',
          icon: <Lightbulb className="w-4 h-4" />,
          path: '/dashboard/instructor/hub/prompts',
          isNew: true,
        },
        {
          id: 'community',
    ...
    // 7. ACCOUNT
    {
      ...
      children: [
        ...
        },
        {
          ...
          path: '/dashboard/instructor/public-page',
        },
        {
          id: 'availability',
          title: 'Availability',
