            ...
            {[
              ...
              { text: "Science questions", emoji: "🧪" }
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-gradient-to-r from-[#FF0000] to-[#E40000] text-white px-4 py-3 rounded-full font-semibold text-base shadow-lg shadow-[#FF0000]/30 hover:shadow-[#FF0000]/50 transition-all duration-300 border border-[#FF0000]/50"
                >
