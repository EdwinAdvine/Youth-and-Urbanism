    ...
    return (
      <div className="col-span-1 sm:col-span-2 bg-[#181C1F] border border-[#22272B] rounded-xl p-5">
        <div className="animate-pulse space-y-3">
          <div className="h-5 w-36 bg-[#22272B] rounded" />
          {[1, 2, 3, 4].map((i) => (
        ...
        {CATEGORY_CONFIG.map((cat) => {
          ...
          return (
            <button
              ...
              className="w-full flex items-center justify-between p-3 rounded-lg bg-[#22272B]/50 border border-[#22272B] hover:border-[#333] transition-colors group"
            >
