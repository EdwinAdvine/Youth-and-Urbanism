          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200">
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="px-4 py-2 text-sm font-medium text-white bg-copilot-blue rounded-lg hover:bg-copilot-blue/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-copilot-blue disabled:opacity-50 flex items-center"
              >
                {isSubmitting && (
