      ...
      <section className="py-16 sm:py-24 bg-[#181C1F]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            variants={fadeInUp}
            transition={{ duration: 0.6 }}
            className="bg-[#0F1112] border border-[#22272B] rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10"
          >
            ...
            <form onSubmit={handleValidate} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-[#181C1F] border border-[#22272B] rounded-xl pl-12 pr-4 py-3.5 text-white placeholder-white/40 focus:outline-none focus:border-[#FF0000]/50 focus:ring-1 focus:ring-[#FF0000]/50 transition-colors text-base"
                  />
                </div>
              </div>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-2 bg-[#FF0000] hover:bg-[#E40000] disabled:opacity-60 disabled:cursor-not-allowed text-white px-6 py-3.5 rounded-xl font-semibold text-base transition-all duration-200 hover:scale-[1.02]"
                >
                ...
                {validationState !== 'idle' && validationState !== 'loading' && (
                  <button
                    type="button"
                    onClick={handleReset}
                    className="px-5 py-3.5 border border-[#22272B] hover:border-white/30 text-white/70 hover:text-white rounded-xl font-medium transition-colors"
                  >
                    Reset
                  </button>
                )}
          ...
          {validationState === 'loading' && (
            <motion.div
              ...
              className="mt-8 bg-[#0F1112] border border-[#22272B] rounded-2xl p-8 text-center"
            >
              <Loader2 className="w-10 h-10 text-[#FF0000] animate-spin mx-auto mb-4" />
              <p className="text-white/70">Verifying certificate authenticity...</p>
            </motion.div>
          )}
          ...
          {validationState === 'success' && certificate && (
            <motion.div
              ...
              className="mt-8 bg-[#0F1112] border-2 border-green-500/40 rounded-2xl sm:rounded-3xl p-6 sm:p-8"
            >
              <div className="flex items-center gap-3 mb-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 bg-[#181C1F] rounded-xl p-4 border border-[#22272B]">
                ...
                <div className="flex items-center gap-3 bg-[#181C1F] rounded-xl p-4 border border-[#22272B]">
                  ...
                  <div>
                    <p className="text-xs text-white/50">Course Name</p>
                    <p className="text-base font-semibold text-white">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center gap-3 bg-[#181C1F] rounded-xl p-4 border border-[#22272B]">
                    ...
                    <div>
                      <p className="text-xs text-white/50">Date Issued</p>
          ...
          {validationState === 'error' && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
              className="mt-8 bg-[#0F1112] border-2 border-red-500/40 rounded-2xl sm:rounded-3xl p-6 sm:p-8"
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {[
                ...
                <motion.div
                  ...
                  className="bg-[#181C1F] border border-[#22272B] rounded-2xl p-6 text-center"
                >
