...
import { Smile, Meh, Frown, Coffee, Zap } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <button
        ...
        className={`w-full px-6 py-3 bg-[#FF0000] hover:bg-[#FF0000]/80 disabled:bg-gray-100 dark:disabled:bg-white/10 disabled:cursor-not-allowed text-gray-900 dark:text-white font-medium ${borderRadius}`}
      >
        Save Mood Check-in
      </button>
    </div>
