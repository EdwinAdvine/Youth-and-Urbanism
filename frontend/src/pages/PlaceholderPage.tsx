...
const PlaceholderPage: React.FC<PlaceholderPageProps> = ({ title = 'This Page' }) => {
  return (
    <div className="min-h-[60vh] flex items-center justify-center bg-[#0F1112] dark:bg-[#0F1112] px-4">
      <div className="text-center max-w-lg">
        ...
        <Link
          to="/"
          className="inline-flex items-center gap-2 bg-[#FF0000] hover:bg-[#E40000] text-white px-6 py-3 rounded-xl font-semibold transition-colors"
        >
