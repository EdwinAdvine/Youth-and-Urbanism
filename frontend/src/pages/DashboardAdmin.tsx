    ...
    <DashboardLayout role="admin">
      <div className="space-y-8">
        ...
        <motion.div variants={stagger} initial="hidden" animate="visible" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 mb-8">
          <motion.div variants={fadeUp} className="lg:col-span-2 bg-[#181C1F] border border-[#22272B] rounded-xl p-6">
          ...
          <motion.div variants={fadeUp} className="lg:col-span-2 bg-[#181C1F] border border-[#22272B] rounded-xl p-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <motion.button whileHover={{ scale: 1.02 }} className="p-4 bg-[#22272B] rounded-lg hover:bg-[#2A3035] transition-colors text-left">
            ...
            <motion.div variants={fadeUp}>
              <div className="bg-[#181C1F] border border-[#22272B] rounded-xl p-6">
                ...
                <div className="space-y-3">
                  ...
                  <motion.button whileHover={{ scale: 1.02 }} className="w-full text-left p-3 bg-[#22272B] rounded-lg hover:bg-[#2A3035] transition-colors">
