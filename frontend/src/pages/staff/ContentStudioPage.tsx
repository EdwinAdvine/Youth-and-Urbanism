    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0F1112] p-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1 bg-white dark:bg-[#181C1F] border border-gray-200 dark:border-[#22272B] rounded-lg p-1">
              ...
              <button className="p-1.5 rounded text-gray-400 dark:text-white/40">
        ...
        <div className="grid grid-cols-3 gap-4">
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-white dark:bg-[#181C1F] border border-gray-200 dark:border-[#22272B] rounded-xl p-4 hover:border-[#E40000]/30 cursor-pointer">
              <div className="aspect-video bg-gray-100 dark:bg-[#22272B] rounded-lg mb-3" />
              <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-1">Content Item {i}</h3>
              <p className="text-xs text-gray-400 dark:text-white/40">Grade 8 • Mathematics</p>
            </div>
          ))}
        </div>
      </div>
