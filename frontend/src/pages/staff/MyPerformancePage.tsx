  ...
  return (
    <div className="min-h-screen bg-[#0F1112] p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-2xl font-bold text-white mb-6">My Performance</h1>
        ...
        <div className="bg-[#181C1F] border border-[#22272B] rounded-xl p-6">
          ...
          <div className="h-64 flex items-center justify-center bg-[#22272B]/30 rounded-lg">
            <p className="text-sm text-white/30">Performance chart visualization</p>
          </div>
        </div>
      </div>
    </div>
