      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white dark:bg-[#181C1F] border border-gray-200 dark:border-[#22272B] rounded-xl p-5">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 dark:text-white/40">Team Morale</p>
              </div>
            </div>
          </div>
          <div className="bg-white dark:bg-[#181C1F] border border-gray-200 dark:border-[#22272B] rounded-xl p-5">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 dark:text-white/40">Productivity</p>
              </div>
            </div>
          </div>
          <div className="bg-white dark:bg-[#181C1F] border border-gray-200 dark:border-[#22272B] rounded-xl p-5">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 dark:text-white/40">Active Discussions</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#181C1F] border border-gray-200 dark:border-[#22272B] rounded-xl p-6">
          ...
          <div className="space-y-2">
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex items-center gap-3 p-3 bg-gray-100 dark:bg-[#22272B]/50 rounded-lg">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-900 dark:text-white font-medium">Team Member {i}</p>
                  <p className="text-xs text-gray-400 dark:text-white/40">Support Specialist</p>
                </div>
                <div className="text-right">
                  <p className="text-sm text-green-400">Active</p>
                  <p className="text-xs text-gray-400 dark:text-white/40">15 tasks this week</p>
                </div>
              </div>
            ))}
          </div>
