        ...
        <div className="bg-white dark:bg-[#181C1F] border border-gray-200 dark:border-[#22272B] rounded-xl p-6">
          <div className="flex items-start gap-6 mb-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-500 dark:text-white/50">Support Specialist</p>
          ...
          <div className="flex gap-2 mt-6 pt-6 border-t border-gray-200 dark:border-[#22272B]">
            ...
            <button className="px-4 py-2.5 bg-gray-50 dark:bg-white/5 text-gray-500 dark:text-white/50 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10">
              Cancel
            </button>
          </div>
        </div>
