...
class TestUserRegistration:
    ...
    async def test_register_all_roles_success(self, client):
    ...
    async def test_register_invalid_role_fails(self, client):
    ...
    async def test_register_missing_required_fields_fails(self, client):
...
class TestUserLogin:
    ...
    async def test_login_inactive_user_fails(self, client, db_session, test_user):
    ...
    async def test_login_deleted_user_fails(self, client, db_session, test_user):
    ...
    async def test_login_case_insensitive_email(self, client, test_user):
...
class TestTokenRefresh:
    ...
    async def test_refresh_missing_token_fails(self, client):
...
class TestGetCurrentUser:
    ...
    async def test_get_current_user_no_token_fails(self, client):
        """Test getting current user without token returns 401."""
        response = await client.get("/api/v1/auth/me")

        assert response.status_code == status.HTTP_401_UNAUTHORIZED

    async def test_get_current_user_invalid_token_fails(self, client):
    ...
    async def test_get_current_user_malformed_header_fails(self, client):
    ...
    async def test_get_current_user_expired_token_fails(self, client):
...
class TestAuthenticationFlow:
    ...
    async def test_complete_auth_flow_student(self, client, db_session):
    ...
    async def test_multiple_role_registrations(self, client):
