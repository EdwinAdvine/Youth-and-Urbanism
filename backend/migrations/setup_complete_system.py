#!/usr/bin/env python3
"""
Complete setup script for the multi-role authentication system.
This script creates all tables and pre-populates with the specified test users.
"""
...
def create_tables():
    ...
    try:
        ...
        try:
            ...
            print(f"⚠️  Could not drop existing tables: {e}")
...
def verify_users(db: Session):
    ...
    for user in users:
        ...
        elif user.role == 'external_instructor':
