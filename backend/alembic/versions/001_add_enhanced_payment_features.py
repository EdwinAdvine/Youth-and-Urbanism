...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('plan_type', postgresql.ENUM(name='plan_type_enum'), nullable=False),
        sa.Column('billing_cycle', postgresql.ENUM(name='billing_cycle_enum'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM(name='subscription_status_enum'), nullable=False, server_default='active'),
    ...
    op.create_table(
        ...
        sa.Column('user_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('users.id', ondelete='CASCADE'), nullable=False),
        sa.Column('refund_type', postgresql.ENUM(name='refund_type_enum'), nullable=False),
        sa.Column('refund_reason', postgresql.ENUM(name='refund_reason_enum'), nullable=False),
        sa.Column('refund_amount', sa.Numeric(10, 2), nullable=False),
        sa.Column('original_amount', sa.Numeric(10, 2), nullable=False),
        sa.Column('currency', sa.String(3), nullable=False, server_default='KES'),
        sa.Column('status', postgresql.ENUM(name='refund_status_enum'), nullable=False, server_default='pending'),
