    ...
    <div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-12">
        ...
        <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-6 hover:border-red-300 dark:hover:border-red-700 transition-colors">
          ...
          <div className="space-y-2">
            ...
            <Link to="/docs/uhs/student" className="block text-sm text-red-600 dark:text-red-400 hover:underline">Student Guide</Link>
            <Link to="/docs/uhs/parent" className="block text-sm text-red-600 dark:text-red-400 hover:underline">Parent Guide</Link>
            <Link to="/docs/uhs/instructor" className="block text-sm text-red-600 dark:text-red-400 hover:underline">Instructor Guide</Link>
            <Link to="/docs/uhs/courses" className="block text-sm text-red-600 dark:text-red-400 hover:underline">Courses & Learning</Link>
            <Link to="/docs/uhs/payments" className="block text-sm text-red-600 dark:text-red-400 hover:underline">Payments</Link>
          </div>
        </div>
        ...
        <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-6 hover:border-blue-300 dark:hover:border-blue-700 transition-colors">
          ...
          <div className="space-y-2">
            <Link to="/docs/bird/ai-tutor" className="block text-sm text-blue-600 dark:text-blue-400 hover:underline">AI Tutor Guide</Link>
            <Link to="/docs/bird/co-pilot" className="block text-sm text-blue-600 dark:text-blue-400 hover:underline">CoPilot Guide</Link>
            <Link to="/docs/bird/voice-mode" className="block text-sm text-blue-600 dark:text-blue-400 hover:underline">Voice Mode</Link>
            <Link to="/docs/bird/learning-paths" className="block text-sm text-blue-600 dark:text-blue-400 hover:underline">Learning Paths</Link>
          </div>
        </div>
      </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        {[
          ...
          { label: 'Assessments', path: '/docs/uhs/assessments', description: 'Quizzes, assignments, projects, exams', icon: 'Q' },
          { label: 'Forum', path: '/docs/uhs/forum', description: 'Community discussions and Q&A', icon: 'F' },
          { label: 'Store', path: '/docs/uhs/store', description: 'E-commerce and product catalog', icon: 'S' },
          { label: 'Certificates', path: '/docs/uhs/certificates', description: 'Earning and validating certificates', icon: 'C' },
